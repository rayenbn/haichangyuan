                ...
                <div class="card-body">
                    ...
                    @endif
                            ...
                            <div class="form-group  row{{ $errors->has('desc') ? 'has-error' : '' }}">
                                <label for="desc" class="col-md-2 col-form-label ">{{ trans('global.aboutus.fields.description') }}</label>
                                <div class="col-md-10">
                                    <input type="text" id="desc" name="desc" class="form-control" value="{{ old('desc', isset($productpage) ? $productpage->desc : '') }}" placeholder="Page Description" required>
                                    @if ($errors->has('desc'))
                                    <span class="invalid-feedback" role="alert">
